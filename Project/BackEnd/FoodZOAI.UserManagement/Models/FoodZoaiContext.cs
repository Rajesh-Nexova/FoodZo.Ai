...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=SWIFT\\MSSQLSERVER01;Database=FoodZOAI;Integrated Security=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Role>(entity =>
        {
            ...
            entity.HasOne(d => d.Organization).WithMany(p => p.Roles)
                ...
                .HasConstraintName("FK__roles__organizat__4F7CD00D");
        });
        ...
        modelBuilder.Entity<RolePermission>(entity =>
        {
            ...
            entity.HasOne(d => d.GrantedByNavigation).WithMany(p => p.RolePermissions)
                ...
                .HasConstraintName("FK__role_perm__grant__619B8048");

            entity.HasOne(d => d.Permission).WithMany(p => p.RolePermissions)
                .HasForeignKey(d => d.PermissionId)
                .HasConstraintName("FK__role_perm__permi__60A75C0F");

            entity.HasOne(d => d.Role).WithMany(p => p.RolePermissions)
                .HasForeignKey(d => d.RoleId)
                .HasConstraintName("FK__role_perm__role___5FB337D6");
        });
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.InverseCreatedByNavigation)
                ...
                .HasConstraintName("FK__users__created_b__4222D4EF");

            entity.HasOne(d => d.Organization).WithMany(p => p.Users)
                .HasForeignKey(d => d.OrganizationId)
                .HasConstraintName("FK__users__organizat__412EB0B6");
        });
        ...
        modelBuilder.Entity<UserPermission>(entity =>
        {
            ...
            entity.HasOne(d => d.GrantedByNavigation).WithMany(p => p.UserPermissionGrantedByNavigations)
                .HasForeignKey(d => d.GrantedBy)
                .HasConstraintName("FK__user_perm__grant__68487DD7");

            entity.HasOne(d => d.Permission).WithMany(p => p.UserPermissions)
                .HasForeignKey(d => d.PermissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_perm__permi__6754599E");

            entity.HasOne(d => d.User).WithMany(p => p.UserPermissionUsers)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_perm__user___66603565");
        });
        ...
        modelBuilder.Entity<UserProfile>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.UserProfiles)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_prof__user___48CFD27E");
        });
        ...
        modelBuilder.Entity<UserRole>(entity =>
        {
            ...
            entity.HasOne(d => d.AssignedByNavigation).WithMany(p => p.UserRoleAssignedByNavigations)
                ...
                .HasConstraintName("FK__user_role__assig__5AEE82B9");
        ...
        modelBuilder.Entity<UserSession>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.UserSessions)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_sess__user___6E01572D");
        });
