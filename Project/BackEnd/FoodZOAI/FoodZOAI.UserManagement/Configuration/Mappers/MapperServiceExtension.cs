...
namespace FoodZOAI.UserManagement.Configuration
{
    ...
    {
        public static IServiceCollection AddReminderMappers(this IServiceCollection services)
        {
            ...
            //services.AddScoped<IReminderNotificationMapper, ReminderNotificationMapper>();
            //services.AddScoped<IReminderSchedulerMapper, ReminderSchedulerMapper>();
            services.AddScoped<IReminderUserMapper, ReminderUserMapper>();
            //services.AddScoped<IUserNotificationMapper, UserNotificationMapper>();
            services.AddScoped<IUserSessionMapper, UserSessionMapper>();
            return services;
        }

        public static IServiceCollection AddReminderRepositories(this IServiceCollection services)
        {
