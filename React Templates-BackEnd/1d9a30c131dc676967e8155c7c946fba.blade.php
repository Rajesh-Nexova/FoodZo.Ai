<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-sort-down" viewBox="0 0 16 16" role="img" path="bs.sort-down" componentName="orchid-icon">
