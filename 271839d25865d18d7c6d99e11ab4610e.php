            ...
            <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($key); ?>"
                        <?php if(isset($value)): ?>
                            ...
                            <?php elseif(!$isOptionList && $key == $value): ?> selected
                            <?php endif; ?>
                        <?php endif; ?>
...
<?php /**PATH /Users/george/Dropbox/code/dine-hub/backend/vendor/orchid/platform/resources/views/fields/select.blade.php ENDPATH**/ ?>